...
@WebServlet(urlPatterns = {"/StateDataServet"})
public class StateDataServet extends HttpServlet {
   ...
   ServletContext context=getServletContext();
    ...
    ps1=con.prepareStatement("select * from info where state=? ");
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        response.setContentType("text/html;charset=UTF-8");
         ...
         out.println("<h2>Data For State :"+state+"</h2>");
         out.println("<hr>");
         out.println("<table border=2>");
         out.println("<tr>");
         out.println("<th>S.NO</th><th>DATE</th><th>TOTAL</th><th>ACTIVE</th><th>DEATHS</th>");
         out.println("</tr>");
         while(rs.next())
         {
